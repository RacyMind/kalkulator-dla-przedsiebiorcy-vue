  ...
  <footer class="py-10 bg-gray-900 text-gray-400">
    <div class="max-w-6xl mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          <h3 class="hidden md:block md:invisible mb-3" aria-hidden="true">&nbsp;</h3>
          <ul class="space-y-2 text-sm">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><a href="https://lukasz-socha.pl/" target="_blank" rel="noopener" class="hover:text-white transition-colors no-underline">Strona twórcy</a></li>
