...
HTML,
    ...
    'related' => [
        ...
        ['slug' => 'kalkulator-refundacja-skladek-spolecznych-pfron', 'name' => 'Refundacja składek PFRON', 'desc' => 'Oblicz kwotę refundacji składek społecznych PFRON.', 'gradient' => 'from-amber-500 to-amber-700', 'icon' => $icons['calculator']],
    ],
];
