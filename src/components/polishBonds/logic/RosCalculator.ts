...
export class RosCalculator extends BasicCalculator<RosInputFields, Result> implements Calculator<RosInputFields, Result> {
  ...
  public calculate(): this {
    ...
    const maxMonths = 72 // ROS bonds have a 6-year maturity period
    ...
    for(let i = 0; i < maxMonths; i++) {
      ...
      if (currentYear === 0) {
        ...
        yearlyRate = helpers.round(
          inflationRate + 
          bondConstants.ros.inflationMargin, 
          4,
        )
      }
