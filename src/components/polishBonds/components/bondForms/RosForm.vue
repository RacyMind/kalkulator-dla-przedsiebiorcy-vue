...
const initialInterestRate = useLocalStorage('polishBonds/form/ros/initialInterestRate', helpers.round(constants.ros.initialInterestRate * 100, 2), { mergeDefaults: true })
