...
const initialInterestRate = useLocalStorage('polishBonds/form/rod/initialInterestRate', helpers.round(constants.rod.initialInterestRate * 100, 2), { mergeDefaults: true })
