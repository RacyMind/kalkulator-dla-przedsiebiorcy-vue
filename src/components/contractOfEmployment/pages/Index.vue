  ...
  <ModulePageLayout class="c-work">
    ...
    <template #results>
      ...
      >
        ...
        <q-tab :name="Tabs.Employee" label="Pracownik" />
        <q-tab :name="Tabs.Employer" label="Pracodawca" />
      </QTabs>
      <q-tab-panels
        :key="tabPanelsKey"
        v-model="tab"
      ...
      >
        ...
        <q-tab-panel :name="Tabs.Employee" class="q-pa-none">
          <EmployeeTabPanel v-if="employeeResult" :result="employeeResult" />
          <div v-else class="q-pa-md">Brak danych</div>
        </q-tab-panel>
        <q-tab-panel :name="Tabs.Employer" class="q-pa-none">
          <EmployerTabPanel v-if="employerResult" :result="employerResult" />
          <div v-else class="q-pa-md">Brak danych</div>
        </q-tab-panel>
      </q-tab-panels>
    </template>
