 ...
 */
function getMonthlyResult (input:InputFields, month = 0):ContractOfEmploymentEmployeeSingleResult {
  let basisForTax = 0
  let taxAmount = 0
  let expenses = 0
 ...
 */
function getYearlyResult (monthlyInputs:InputFields[]):ContractOfEmploymentEmployeeYearlyResult {
