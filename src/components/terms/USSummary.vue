<template>
  <div>
    <ListRow>
      <template #name>Wpłata zaliczki na podatek dochodowy</template>
      <template #description>do 20. dnia miesiąca</template>
    </ListRow>
    <ListRow>
      <template #name>Wpłata podatku VAT</template>
      <template #description>do 25. dnia miesiąca</template>
    </ListRow>
    <ListRow>
