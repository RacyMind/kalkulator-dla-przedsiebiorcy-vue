...
const { hasPercentageForEachMonth: hasAuthhorExpensesForEachMonth, monthlyValues: expensesMonthlyValues } = useMonthlyPercentages(partOfWorkWithAuthorExpenses, 'contractOfMandate/form/authorExpenses')
