...
describe('investment', () => {
  it('12 months, 10%, 10000', () => {
    const { capital, grossAmount, netAmount, taxAmount } =
      investment.getResult(defaultInput)
  ...
  it('6 months, 10%, 10000', () => {
    const { capital, grossAmount, netAmount, taxAmount } = investment.getResult(
      { ...defaultInput, monthCount: 6 },
    )
    expect(capital).toBe(10000)
  ...
  it('12 months, 5%, 5000', () => {
    const { capital, grossAmount, netAmount, taxAmount } = investment.getResult(
      { ...defaultInput, amount: 5000, rate: 0.05 },
    )
  ...
  it('6 months, 5%, 5000', () => {
    const { capital, grossAmount, netAmount, taxAmount } = investment.getResult(
      { monthCount: 6, amount: 5000, rate: 0.05 },
    )
    expect(capital).toBe(5000)
  ...
  it('3 months, 5%, 5000', () => {
    const { capital, grossAmount, netAmount, taxAmount } = investment.getResult(
      { monthCount: 3, amount: 5000, rate: 0.05 },
    )
    expect(capital).toBe(5000)
  ...
  it('1 month, 5%, 5000', () => {
    const { capital, grossAmount, netAmount, taxAmount } = investment.getResult(
      { monthCount: 1, amount: 5000, rate: 0.05 },
    )
    expect(capital).toBe(5000)
